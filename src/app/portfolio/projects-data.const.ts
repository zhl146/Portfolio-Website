import { Feature, Project } from './project.model';
...
export const projects = [
  new Project( 'Project 1',
    ...
    ' sem at dolor. Maecenas mattis. Sed convallis tristique sem. Proin ut ligula' +
    ' vel nunc egestas porttitor. Morbi lectus risus, iaculis vel, suscipit quis,' +
    ' luctus non, massa. Fusce ac turpis quis ligula lacinia aliquet. Mauris ipsum.' +
    ' Nulla metus metus, ullamcorper vel, tincidunt sed, euismod in, nibh.',
    'http://imageshack.com/a/img537/786/9ZkQcJ.jpg',
    '',
    '',
    [
